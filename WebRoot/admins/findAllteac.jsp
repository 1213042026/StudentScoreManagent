		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
	                ...
	                <h1 class="page-title"> 教师列表
	                    <small>这里有教师的基本信息</small>
	                </h1>
					<!-- END PAGE BAR -->
					<!-- END PAGE HEADER-->
					<div class="row">
					...
					<%-- <table>
						...
						<tr>
								...
								<td><s:property value="#l.teac_name" /></td>
								<td><s:property value="#l.teac_pwd" /></td>
								<td><a href="deleteByIdteachers?teac_id=<s:property value='#l.teac_id'/>">删除</a></td>
						</tr>
							</s:iterator>
					</table> --%>
		                                 ...
		                                 <table class="table table-bordered">
		                                     ...
		                                     <tbody class="text-center">
		                                         ...
		                                         <tr>
		                                             ...
		                                             <td> <s:property value="#l.teac_pwd"/> </td>
		                                             <td> 
		                                             	<a href="deleteByIdteachers?teac_id=<s:property value='#l.teac_id'/>" class="btn red mt-ladda-btn ladda-button" data-style="slide-down" onClick="delcfm()">
