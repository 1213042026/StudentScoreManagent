		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
	                ...
	                <h1 class="page-title"> 添加教师
	                    <small>在这里可以添加教师</small>
	                </h1>
					<!-- END PAGE BAR -->
					<!-- END PAGE HEADER-->
					<div class="row">
						<%-- <s:form action="insertteachers">
							<s:textfield label="教师编号" name="teacher.teac_id" />
							<s:textfield label="教师姓名" name="teacher.teac_name" />
							<s:password label="教师密码" name="teacher.teac_pwd" />
							<s:submit value="添加" />
							<s:reset value="重置" />
						</s:form> --%>
	                		...
	                		<div class="portlet light bordered">
	                               <div class="portlet-title">
	                                   <div class="caption font-red-sunglo">
	                                       ...
	                                       <span class="caption-subject bold uppercase"> 添加教师</span>
	                                   </div>
	                               </div>
	                                   ...
	                                   <form action="insertteachers" method="post">
	                                       <div class="form-body">
	                                           <div class="form-group form-md-line-input has-info">
	                                               <input type="text" name="teacher.teac_id" class="form-control" id="form_control_1" placeholder="教师编号" value="">
	                                               <label for="form_control_1">教师编号</label>
	                                           </div>
	                                           <div class="form-group form-md-line-input has-info">
	                                               <input type="text" name="teacher.teac_name" class="form-control" id="form_control_1" placeholder="教师姓名" value="">
	                                               <label for="form_control_1">教师姓名</label>
	                                           </div>
	                                           <div class="form-group form-md-line-input has-info">
	                                               <input type="text" name="teacher.teac_pwd" class="form-control" id="form_control_1" placeholder="教师密码" value="">
