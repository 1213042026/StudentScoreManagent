    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <h1 class="page-title"> 学生列表
                    <small>这里有学生的基本信息</small>
                </h1>
                <!-- END PAGE BAR -->
                <!-- END PAGE HEADER-->
                <div class="row">
			...
			<tr>
					...
					<td><a href="studeleteById?stu_id=<s:property value='#l.stu_id'/>">删除</a></td>
			</tr>
				</s:iterator>
		</table> --%>
	                                 ...
	                                 <table class="table table-bordered">
	                                     ...
	                                     <tbody class="text-center">
	                                         ...
	                                         <tr>
	                                             ...
	                                             <td> <s:property value="#l.stu_address"/> </td>
	                                             <td> 
	                                             	<a href="studeleteById?stu_id=<s:property value='#l.stu_id'/>" class="btn red mt-ladda-btn ladda-button" data-style="slide-down" onClick="delcfm()">
