    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <h1 class="page-title"> 添加课程
                    <small>在这里可以添加课程</small>
                </h1>
                <!-- END PAGE BAR -->
                <!-- END PAGE HEADER-->
                <div class="row">
                		<%-- <s:form action="courinsert">
		<s:textfield label="课程编号" name="course.cour_id" />
		<s:textfield label="教师编号" name="course.teac_id" />
		<s:textfield label="课程名称" name="course.cour_name" />
		<s:submit value="添加" />
		<s:reset value="重置" />
	</s:form> --%>	
                		...
                		<div class="portlet light bordered">
                               <div class="portlet-title">
                                   <div class="caption font-red-sunglo">
                                       ...
                                       <span class="caption-subject bold uppercase"> 添加课程</span>
                                   </div>
                               </div>
                               <div class="portlet-body form">
                                   <form action="courinsert" method="post">
                                       <div class="form-body">
                                           <div class="form-group form-md-line-input has-info">
                                               <input type="text" name="course.cour_id" class="form-control" id="form_control_1" placeholder="课程编号" value="">
                                               <label for="form_control_1">课程编号</label>
                                           </div>
                                           <div class="form-group form-md-line-input has-info">
                                               <input type="text" name="course.teac_id" class="form-control" id="form_control_1" placeholder="教师编号" value="">
                                               <label for="form_control_1">教师编号</label>
                                           </div>
                                           <div class="form-group form-md-line-input has-info">
                                               <input type="text" name="course.cour_name" class="form-control" id="form_control_1" placeholder="课程名称" value="">
