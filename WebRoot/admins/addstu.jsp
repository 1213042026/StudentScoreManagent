		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
	                ...
	                <h1 class="page-title"> 添加学生
	                    <small>在这里可以添加学生</small>
	                </h1>
					<!-- END PAGE BAR -->
					<!-- END PAGE HEADER-->
					<div class="row">
						<%-- <s:form action="stuinsert">
							<s:textfield label="学生学号" name="stus.stu_id" />
							<s:textfield label="班级编号" name="stus.class_id" />
							<s:textfield label="学生姓名" name="stus.stu_name" />
							<s:password label="学生密码" name="stus.stu_pwd" />
							<s:radio list="#{'男':'男','女':'女'}" label="性别" name="stus.stu_sex" />
							<s:textfield label="学生电话" name="stus.stu_tel" />
							<s:textfield label="学生地址" name="stus.stu_address" />
							<s:submit value="添加" />
							<s:reset value="重置" />
						</s:form> --%>
	                		...
	                		<div class="portlet light bordered">
	                               <div class="portlet-title">
	                                   <div class="caption font-red-sunglo">
	                                       ...
	                                       <span class="caption-subject bold uppercase"> 添加学生</span>
	                                   </div>
	                               </div>
	                                   ...
	                                   <form action="stuinsert" method="post">
	                                       <div class="form-body">
	                                           <div class="form-group form-md-line-input has-info">
	                                               <input type="text" name="stus.stu_id" class="form-control" id="form_control_1" placeholder="学生学号" value="">
	                                               <label for="form_control_1">学生学号</label>
	                                           </div>
	                                           <div class="form-group form-md-line-input has-info">
	                                               <input type="text" name="stus.class_id" class="form-control" id="form_control_1" placeholder="班级编号" value="">
	                                               <label for="form_control_1">班级编号</label>
	                                           </div>
	                                           <div class="form-group form-md-line-input has-info">
	                                               <input type="text" name="stus.stu_name" class="form-control" id="form_control_1" placeholder="学生姓名" value="">
	                                               <label for="form_control_1">学生姓名</label>
	                                           </div>
	                                           <div class="form-group form-md-line-input has-info">
	                                               <input type="text" name="stus.stu_pwd" class="form-control" id="form_control_1" placeholder="学生密码" value="">
	                                               <label for="form_control_1">学生密码</label>
	                                           </div>
	                                           <div class="form-group form-md-line-input has-info" style="padding-top: 0">
	                                           	   <label for="form_control_1">性别</label>
	                                               <div class="md-radio-inline">
	                                                    <div class="md-radio">
	                                                        <input type="radio" id="radio6" name="stus.stu_sex" class="md-radiobtn" checked="" value="男">
	                                                        <label for="radio6">
	                                                            <span class="inc"></span>
	                                                    ...
	                                                    <div class="md-radio">
	                                                        <input type="radio" id="radio7" name="stus.stu_sex" class="md-radiobtn" value="女">
	                                                        <label for="radio7">
	                                                            <span></span>
	                                                            <span class="check"></span>
	                                           ...
	                                           <div class="form-group form-md-line-input has-info">
	                                               <input type="text" name="stus.stu_tel" class="form-control" id="form_control_1" placeholder="学生电话" value="">
	                                               <label for="form_control_1">学生电话</label>
	                                           </div>
	                                           <div class="form-group form-md-line-input has-info">
	                                               <input type="text" name="stus.stu_address" class="form-control" id="form_control_1" placeholder="学生地址" value="">
	                                               <label for="form_control_1">学生地址</label>
	                                           </div>
	                                       </div>
