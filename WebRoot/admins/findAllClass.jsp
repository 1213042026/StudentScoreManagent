						...
						<%-- <table>
							...
							<s:iterator value="list" var="l">
								<tr>
									...
									<td><s:property value="#l.class_name" /></td>
									<td><a
										href="queryByIdstuclass?stuclass_id=<s:property value="#l.class_id"/>">查看班级详情</a></td>
								</tr>
							</s:iterator>
						</table> --%>
		                                 ...
		                                 <table class="table table-bordered">
		                                     ...
		                                     <tbody class="text-center">
		                                         ...
		                                         <tr>
		                                             ...
		                                             <td> <s:property value="#l.class_name"/> </td>
		                                             <td> 
		                                             	<a href="queryByIdstuclass?stuclass_id=<s:property value="#l.class_id"/>" class="btn red mt-ladda-btn ladda-button" data-style="slide-down">
