        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <h1 class="page-title"> 课程查询
                	<s:iterator value="#session.scoreInfo" var="score">
                		<s:set value="#score.cour_name" var="name"/>
                	</s:iterator>
                ...
                <div class="row">
                	<%-- <table border="1" >
                		...
                		<s:iterator value="#session.scoreInfo" var="s">
                		<tr>
                			<td><s:property value="#s.cour_name"/></td>
                			<td><s:property value="#s.stu_name"/></td>
	                	...
	                	<div class="portlet box blue">
	                         <div class="portlet-title">
	                             <div class="caption">
	                                 ...
	                                 <s:property value="#score.cour_name"/> 
	                             </div>
	                         </div>
