            ...
            <div class="page-content">
                ...
                <div class="row">
                	<%-- <table border="1" >
                		...
                		<s:iterator value="#session.scoreList" var="s">
                		<tr>
                			<td><s:property value="#s.cour_id"/></td>
                			<td><a href="scoreInfoteachers?cour_name=<s:property value="#s.cour_name"/>"><s:property value="#s.cour_name"/></a></td>
                		</tr>
                		</s:iterator>
                	</table> --%>
                	<div class="col-lg-6 col-lg-offset-3">
	                	<div class="portlet box blue">
	                         <div class="portlet-title">
	                             <div class="caption">
	                                 <i class="fa fa-cogs"></i>科目成绩查询 </div>
	                         </div>
	                             ...
	                             <div class="table-responsive">
	                                 <table class="table table-bordered">
	                                     ...
	                                     <tbody class="text-center">
	                                         ...
	                                         <tr>
	                                             <td> <s:property value="#s.cour_id"/> </td>
	                                             <td> <s:property value="#s.cour_name"/> </td>
	                                             <td> 
	                                             	<a href="scoreInfoteachers?cour_name=<s:property value="#s.cour_name"/>" class="btn blue"> 查询
