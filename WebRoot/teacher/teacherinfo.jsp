    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <h1 class="page-title"> 教师信息
                    <small>在这里是教师的基本信息</small>
                </h1>
                <!-- END PAGE BAR -->
                <!-- END PAGE HEADER-->
                <div class="row">
                	<!--<s:set value="#session.teacher" var="tea"/>
                	教师ID：<s:property value="#tea.teac_id"/>
                	权限ID：<s:property value="#tea.role_id"/>
                	教师名字：<s:property value="#tea.teac_name"/>
                	教师密码：<s:property value="#tea.teac_pwd"/>
                	<a href="teacher/updateteacherinfo.jsp">修改密码</a>-->
                	<div class="col-lg-6 col-lg-offset-3">
	                	<div class="portlet box blue">
	                         <div class="portlet-title">
	                             <div class="caption">
	                                 <i class="fa fa-cogs"></i>教师信息 </div>
	                         </div>
