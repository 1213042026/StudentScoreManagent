            ...
            <div class="page-content">
                ...
                <div class="row">
                	<%-- <table border="1" >
                		...
                		<s:iterator value="#session.courseList" var="c">
                		<tr>
                			<td><s:property value="#c.teac_id"/></td>
                			<td><s:property value="#c.cour_id"/></td>
                			<td><a href="courseInfoteachers?cour_name=<s:property value="#c.cour_name"/>"><s:property value="#c.cour_name"/></a></td>
                		</tr>
                		</s:iterator>
                	</table> --%>
	                                 ...
	                                 <table class="table table-bordered">
	                                     ...
	                                     <tbody class="text-center">
	                                         ...
	                                         <tr>
	                                             ...
	                                             <td> 
	                                             	<a href="courseInfoteachers?cour_name=<s:property value="#c.cour_name"/>" class="btn blue"> 查询
