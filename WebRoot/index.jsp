    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                	<s:if test="#session.role==1">
                    <h1 class="center-block text-center" style="margin-top: 300px">${sessionScope.name},欢迎登录系统!</h1>
                    </s:if>
                    <s:elseif test="#session.role==2">
                    <h1 class="center-block text-center" style="margin-top: 300px">${sessionScope.name} 老师,欢迎登录系统!</h1>
                    </s:elseif>
                    <s:elseif test="#session.role==3">
                    <h1 class="center-block text-center" style="margin-top: 300px">${sessionScope.name} 同学,欢迎登录系统!</h1>
                    </s:elseif>
                </div>
            </div>
            <!-- END CONTENT BODY -->
